                ...
                {post.comments && post.comments.length > 0 && (
                    <div className="ig-comments-section">
                        {!showAllComments && post.comments.length > 2 && (
                            ...
                            >
                                {translations[lang || 'uz']?.viewAll || 'View all'} {post.comments.length} {translations[lang || 'uz']?.comments || 'comments'}
                            </button>
                        )}
                        <div className="ig-comments-list">
                            {(showAllComments ? post.comments : post.comments.slice(-2)).map((comment, idx) => (
                                <div key={idx} className="ig-comment">
                        ...
                        {showAllComments && post.comments.length > 2 && (
                            <button 
                                className="ig-hide-comments"
                                onClick={() => setShowAllComments(false)}
                            >
                                {translations[lang || 'uz']?.hide || 'Hide'} {translations[lang || 'uz']?.comments || 'comments'}
                            </button>
                        )}
                    </div>
                )}
    ...
    return (
        <div className="ig-home">
            ...
            <style jsx="true">{`
                ...
                /* Comments */
                .ig-comments-section { margin-top: 8px; }
                .ig-view-comments { 
                ...
                .ig-view-comments:hover { color: var(--text-primary); }
                .ig-hide-comments { 
                    color: var(--text-secondary); 
                    font-size: 0.85rem; 
                    cursor: pointer; 
                ...
                .ig-hide-comments:hover { color: var(--text-primary); }
                .ig-comments-list { display: flex; flex-direction: column; gap: 6px; }
                .ig-comment { 
                    font-size: 0.9rem; 
                    line-height: 1.3;
                    display: flex;
