...
const Chat = () => {
  ...
  const handleDeleteMessages = async (messageIds, deleteForBoth = true) => {
    try {
      await axios.delete('/api/messages/delete', { data: { messageIds, toUserId: selectedFriend._id, deleteForBoth } });
